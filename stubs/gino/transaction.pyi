# flake8: noqa
# Stubs for gino.transaction (Python 3.7)
#
...
class _Break(BaseException):
    tx: Any = ...
    commit: Any = ...
    def __init__(self, tx: Any, commit: Any) -> None: ...

class GinoTransaction:
    def __init__(self, conn: GinoConnection, args: Any, kwargs: Any) -> None: ...
    @property
    ...
    def __await__(self) -> GinoTransaction: ...
